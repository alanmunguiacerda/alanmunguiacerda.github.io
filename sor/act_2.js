  ...
  carousels: {
    ...
    win: {
      ...
      data: [
        ...
        {
          image: 'media/act_2/win2.png',
          title: 'Crear un nuevo archivo "main.py"',
          description: 'Aquí escribiremos el código para leer los procesos activos. El código es bastante simple, importamos la librería, leemos los "pids" de los procesos e imprimimos el nombre de cada uno.'
        },
        {
          image: 'media/act_2/win3.png',
          title: 'Ejecución',
          description: 'Cerramos el archivo y lo ejecutamos.'
        },
        {
          image: 'media/act_2/win4.png',
          title: 'Resultado',
          description: 'Los nombres de los procesos deberían de aparecer.'
        },
        {
          icon: 'media/download.png',
          link: 'media/act_2/main.py',
